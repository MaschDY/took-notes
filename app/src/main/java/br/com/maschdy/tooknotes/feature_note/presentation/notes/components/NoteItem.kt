package br.com.maschdy.tooknotes.feature_note.presentation.notes.components
...
private fun NoteItemPreview() {
    val note = Note("Title", "Content description", System.currentTimeMillis(), BabyBlue.toArgb())
    TookNotesTheme {
        Surface {
